...
class OTP {
    ...
    public function verifyOTP($pubkey, $otp) {
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://otpapp.org/api/otp/verify/".$otp.'/'.$_SERVER['REMOTE_ADDR'],
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
    ...
    public function verifySesion($pubkey,$code) {
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://otpapp.org/api/otp/session/".$code.'/'.$_SERVER['REMOTE_ADDR'],
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
    ...
    public function closeOTP($pubkey,$code){
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://otpapp.org/api/otp/close/".$code.'/'.$_SERVER['REMOTE_ADDR'],
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
